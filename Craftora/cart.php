                    ...
                    ?>
                        <div class="cart-item">
                            <div class="row align-items-center">
                                <div class="col-md-2">
                                    <img
                                        src="images/products/<?php echo htmlspecialchars($item['image']); ?>"
                                        class="img-fluid rounded" alt="<?php echo htmlspecialchars($item['name']); ?> Handmade Product"
                                        loading="lazy"
                                        decoding="async"
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <button
                                            ...
                                            <?php if ($item['quantity'] <= 1) echo 'disabled'; ?>>
                                        ...
                                        <button
                                            ...
                                            <?php if ($item['quantity'] >= $item['stock']) echo 'disabled'; ?>>
